...
use frankenstein_runtime::WasmEngine;

fn main() -> anyhow::Result<()> {
    tracing_subscriber::fmt::init();
    
    tracing::info!("🚀 Basic Demo - Frankenstein Engine Showcase");
    ...
    // Setup WASM runtime
    let runtime_config = frankenstein_runtime::RuntimeConfig {
...
fn create_demo_world(world: &mut World) -> anyhow::Result<()> {
    use frankenstein_core::api::{Transform, RenderComponent};
    use glam::{Vec3, Quat};
