// This file contains TypeScript type definitions for the Frankenstein engine, ensuring type safety when using the engine's API in TypeScript.

declare module "frankenstein" {
